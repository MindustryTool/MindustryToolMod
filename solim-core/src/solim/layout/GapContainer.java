...
public interface GapContainer {
	...
	/**
	 * Incrementally spaces a newly attached cell along the given direction.
	 * Only subsequent visible cells receive leading gap; first visible cell receives 0.
	...
	/**
	 * Applies directional spacing to all cells of a Table along the given direction.
