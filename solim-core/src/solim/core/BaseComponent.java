 ...
 * management, and automatic child registration.
 *
 * <p>
 * Lifecycle rules:
 * <ul>
 * <li>Resources are disposed in reverse registration order (LIFO).</li>
 * <li>Calling {@link #element()} on a disposed component throws
 * {@link IllegalStateException}.</li>
 * <li>If {@link #build()} throws, all resources registered up to that point are
 * disposed.</li>
 * <li>If {@link #build()} returns {@code null}, an
 * {@link IllegalStateException} is thrown and resources are disposed.</li>
 * </ul>
 */
public abstract class BaseComponent implements Component {
    ...
    private void applyName(Element element) {
        if (componentName != null) {
            ...
            element.name = "solim-" + compName.toLowerCase() + "-" + elemName.toLowerCase();
        }
    }
    ...
    /**
     * Internal framework ownership primitive: adds a disposable resource to this
     * component's disposal list and returns it. Package-private: callable only
     ...
     * specified Arc event fires. Automatically unregisters when this component is
     * disposed.
     */
    ...
    public void dispose() {
        ...
        disposed = true;
        onDispose();
        // Dispose in reverse registration order (LIFO) so later resources are freed
        // first.
