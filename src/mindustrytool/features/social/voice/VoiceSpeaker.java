    ...
    public void open() {
        ...
        try {
            if (isDesktop) {
                ...
                Class<?> implClass = Class.forName("mindustrytool.features.social.voice.DesktopSpeaker");
                ...
                Class<?> implClass = Class.forName("mindustrytool.features.social.voice.AndroidSpeaker");
                platformSpeaker = implClass.getDeclaredConstructor(int.class).newInstance(sampleRate);
                implClass.getMethod("open").invoke(platformSpeaker);
