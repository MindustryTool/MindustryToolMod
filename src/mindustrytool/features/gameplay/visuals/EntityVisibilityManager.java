...
import mindustrytool.core.ui.components.DualContentSelectionTable;
...
public class EntityVisibilityManager {
    ...
    // Reflection
    // SECURITY: These fields are accessed via reflection to toggle internal
    // visibility flags.
    // There is no public API in the game engine to control specific element
    // rendering indices.
