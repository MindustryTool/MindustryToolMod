...
import mindustrytool.features.content.browser.ModKeybinds;
...
public class SmartDrillManager {
    ...
    private void init() {
        ...
        buildSelectTable();
        buildDirectionTable();
        // registerEvents(); // Moved to PlayerConnectFeature for true lazy loading
        // registerDraw(); // Moved to PlayerConnectFeature for true lazy loading
