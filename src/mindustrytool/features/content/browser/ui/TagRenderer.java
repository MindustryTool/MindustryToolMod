...
import mindustrytool.features.content.browser.NetworkImage;
import mindustrytool.features.content.browser.TagData;
    ...
    public static void render(Table table, TagData tag, float scale, Runnable onClick) {
        ...
        table.button(b -> {
            ...
            if (tag.categoryId() != null && !tag.categoryId().isEmpty()) {
                String cat = mindustrytool.features.content.browser.TagService.getCategoryName(tag.categoryId());
