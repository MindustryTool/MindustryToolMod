...
public class DesktopMicrophone {
    ...
    public void open() {
        ...
        try {
            ...
            if (actualSampleRate != targetSampleRate) {
                Log.warn("@ Sample rate mismatch! Target: @, Actual: @. Resampling enabled.", TAG, targetSampleRate,
                        actualSampleRate);
            }
    ...
    public short[] read() {
        ...
        // Calculate how many bytes to read to produce 'bufferSize' samples at target
        // rate
