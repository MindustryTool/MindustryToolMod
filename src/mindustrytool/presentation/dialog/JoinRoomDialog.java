...
import mindustrytool.feature.playerconnect.network.PlayerConnectLink;
import mindustrytool.presentation.builder.LinkValidator;
...
public class JoinRoomDialog extends mindustry.ui.dialogs.BaseDialog {
    ...
    public boolean setLink(String link) {
        ...
        lastLink = link;
        var r = LinkValidator.validate(lastLink);
        output = r.message;
