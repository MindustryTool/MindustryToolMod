package mindustrytool.core.ui.dialogs;

import arc.Core;
import mindustrytool.data.models.CommitInfo;
import mindustrytool.data.models.ReleaseInfo;
import arc.files.Fi;
...
import mindustrytool.core.markdown.MarkdownRenderer;
        ...
        for (int i = 0; i < commits.size; i++) {
            ...
            t.table(row -> {
                ...
                row.table(content -> {
                    ...
                    if (Core.graphics.isPortrait()) {
                        // Ensure positive width before applying upper bound
                        float baseWidth = Math.max(150f, Core.graphics.getWidth() * 0.85f - graphWidth);
                        availableWidth = Math.min(baseWidth, 400f);
                    } else {
