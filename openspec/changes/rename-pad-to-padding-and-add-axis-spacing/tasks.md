...
- [ ] 1.1 Remove `pad*` methods from `ElementModifiers.java` <!-- id: 1.1 -->
...
- [ ] 1.2 Add `paddingX`, `paddingY`, `marginX`, `marginY` to `ElementModifiers.java` <!-- id: 1.2 -->
...
- [ ] 1.3 Add `marginX` and `marginY` to `LayoutModifiers.java` <!-- id: 1.3 -->
...
- [ ] 2.1 Update `Column.java` and `Row.java` <!-- id: 2.1 -->
...
- [ ] 2.2 Update `Text.java`, `SolimImage.java`, and `NetworkImage.java` <!-- id: 2.2 -->
...
- [ ] 2.3 Update `Container.java`, `Card.java`, and `Button.java` <!-- id: 2.3 -->
...
- [ ] 3.1 Migrate existing `pad*` calls in mod code and Solim tests <!-- id: 3.1 -->
  - Replace `.pad()` calls in `AuthOverlay.java` with `.padding()`
  - Migrate Solim component test references from `pad*` to `padding*`
- [ ] 3.2 Add automated unit tests for two-axis spacing <!-- id: 3.2 -->
...
- [ ] 3.3 Execute test suite and verify build <!-- id: 3.3 -->
