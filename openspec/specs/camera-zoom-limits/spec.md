# camera-zoom-limits Specification

## Purpose

Player-adjustable camera minimum and maximum zoom enforcement with persisted settings and a Solim settings dialog. Created by archiving change camera-zoom-limits.

## Requirements

**Source: camera-zoom-limits**
